# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 18:37:35 2024

@author: Ogbodo Gloria
"""
...
def greet_user():
    ...
    SpeakText('I am Wonder. Your personal assistant. How may I assist you?')
...
def chat(query):
    ...
    reply = reply.replace('OpenAI', 'Gloria')
...
if __name__ == '__main__':
    ...
    Gloria_image = face_recognition.load_image_file(
        r"1728591723978.jpg")
    Gloria_face_encoding = face_recognition.face_encodings(Gloria_image)[0]

    # Create arrays of known face encodings and their names
    known_face_encodings = [
        
        Gloria_face_encoding
    ]
    known_face_names = [
        "Gloria"
    ]
